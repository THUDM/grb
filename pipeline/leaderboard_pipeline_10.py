...
if __name__ == '__main__':
    ...
    for n_a in range(args.n_attack):
        ...
        for dataset_mode in args.dataset_mode:
            ...
            if args.attack_dir:
                ...
                for attack_name in attack_dict:
                    ...
                    features_attack = np.load(os.path.join(attack_dict[attack_name], str(n_a), args.attack_feat_name))
                    with open(os.path.join(attack_dict[attack_name], str(n_a), args.attack_adj_name), 'rb') as f:
        ...
        if args.save_dir is not None:
            utils.save_df_to_xlsx(df=result_df,
                                  file_dir=os.path.join(args.save_dir, str(n_a)),
