...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset", type=str, default="grb-social")
    parser.add_argument("--data_dir", type=str, default="/home/stanislas/Research/GRB/data/grb-social/")
    parser.add_argument("--model_dir", type=str, default="/home/stanislas/Research/GRB/saved_models/grb-social/")
